  ...
  async run() {
    try {
      const sessionsData = [
        ...
        {
          noteId: '9397b533-81c0-481e-b49c-909dae7fcadb',
          sessionId: 'session-4',
        ...
        {
          noteId: '817ac79e-c818-41b9-bcea-54aab75042e3',
          sessionId: 'session-6',
        ...
        {
          noteId: '6a3e4239-bd1a-4f0a-8e4a-7c8e88f4f21d',
          sessionId: 'session-8',
        ...
        {
          noteId: 'cf799158-fc0c-4ffb-aaab-a0c8dd2484f7',
        ...
        {
          noteId: '95139808-e0cb-41ea-8db1-265c4d6098e3',
        ...
        {
          noteId: 'b9521ac5-9919-4baa-8a1c-7100a97511f4',
        ...
        {
          noteId: 'cc9c3442-f17c-4b84-8391-c165ca8df879',
        ...
        {
          noteId: '505f2079-107c-4ce0-aa3e-95e88621c459',
        ...
        {
          noteId: 'f19e007b-fe0e-49bd-b79f-8f911de2e1a2',
        ...
        {
          noteId: '4b2e90f4-23e7-42fa-b106-cd0b9854701b',
        ...
        {
          noteId: '491c2bcf-635d-41f4-a33f-dacf717955cc',
        ...
        {
          noteId: 'd7be4b6a-cc29-46c6-accf-3107520ef083',
        ...
        {
          noteId: 'e6d7da1f-61b9-4309-9f8e-b0d41eb9f2d4',
        ...
        {
          noteId: '4fb2212d-7c21-46f3-98f2-ee9d65de749c',
        ...
        {
          noteId: 'c9f85d9e-7aaf-4b58-ae0e-9e0c2b1bf3ac',
        ...
        {
          noteId: '2d90f451-afa1-40d4-b495-9f3270a734c0',
        ...
        {
          noteId: 'c669368c-4ae5-42f0-84ad-8496302f54e3',
        ...
        {
          noteId: 'aa1f8713-7a21-4901-9b9e-4409ab51a01a',
          sessionId: 'session-41',
          session: {
            'Session Duration': '12 pm - 12:53 pm.',
            'Encounter Type & Method': 'Video Telehealth',
            'Mental Status (optional)': '',
            'Suicidality': 'Not Present',
            'Homicidality': 'Not Present',
            'Subjective':
              '- Writer and client explored his triggers and emotions around the holidays.\n\nClient reported his one friend is his support system.\nWriter and client discussed his thoughts with starting his bank job next week.',
            'Objective': 'No odd or abnormal behaviors noted.',
            'Assessment & Therapeutic Intervention': 'EFT and Motivational Interviewing.',
            'Reaction to Intervention': "Client was receptive of writer's intervention feedback.",
            'Plan and Collaboration': 'Continue to explore symptoms.',
            'Therapist Reflection and Insight (optional)': '',
            'Progress': 'Progress',
            'Full Name & Credentials (Signature)': 'Chelsea Noel, LMHC',
        ...
        },
        {
          ...
          session: {
            ...
            'Homicidality': 'Not Present',
            'Subjective':
              '- Client reported he received the bank job offer and his thoughts surrounding this. \n\nClient reported he has been journaling more.\nWriter and client explored his childhood and the concept of nature versus nurture. \nWriter and client discussed networking skills to help promote his creative endeavors.',
            'Objective': 'No odd or abnormal behaviors noted.',
        ...
        {
          noteId: 'b2a2fc73-ce40-4d36-9a84-1e6103db86d7',
          sessionId: 'session-43',
          session: {
            'Session Duration': '7-8pm',
            'Encounter Type & Method': 'Video Telehealth',
            'Mental Status (optional)': '',
            'Suicidality': 'Not Present',
            'Homicidality': 'Not Present',
            'Subjective':
              'Last session tonight. On the East Coast today. snowed in. Want to spend half session free flow and half capitalizing on the goals.\nFeeling pretty present, like know where own center is now, seeing the stuff in the mind as stuff in the mind, not necessarily acting on it. Lots of synchronicities...\nFeel like can ease into own center, not feel like doing it wrong... not feel like finding and losing it and finding and losing it... deeper sense of stability. Choosing self and life that creating.',
            'Objective': 'reflective with a sense of stability and strength',
            'Assessment & Therapeutic Intervention':
              'The writer and Rafaelina processed the changes and new relational dynamics. The writer provided reflective listening, validation, encouragement, psychoeducation, and support. the writer and Rafaelina reviewed and capitalized her gains based on her treatment goals.',
            'Reaction to Intervention': 'insight\nclarity\ncuriosity',
            'Plan and Collaboration':
              'Continue somatic experiencing work independently to deepen safety and resilience in the nervous system. The writer and Rafaelina terminated the relationship and work together at this time.',
            'Therapist Reflection and Insight (optional)':
              'Rafaelina made amazing progress working together and will be able to continue her growth independently or  with another therapist if chooses so.',
            'Progress': 'Progress',
            'Full Name & Credentials (Signature)':
              'Tetyana Sabers MHC-LP/ Wendy Pinder CAGS MA LMHC',
            'Date Completed': '12/15/2025',
            'Documented by Supervised Clinician (if applicable)': 'Tetyana Sabers MHC-LP',
          },
          practitionerId: 2,
          patientId: 26,
          type: SessionTypeEnum.intake,
        },
        {
          ...
          session: {
            'Session Duration': '8-9pm',
            'Encounter Type & Method': 'Video Telehealth',
            'Mental Status (optional)': '',
            'Suicidality': 'Not Present',
            'Homicidality': 'Not Present',
            'Subjective':
              'Has been a month with the new job already. Many insights and learning. To do list that had evolved into more of a setting intention as wake up... Feel nervous system settling in... Met someone at an exotic dancing and spending some time together... insightful presence... conflict with Paul though, he expressed fear, and so "don\'t want to be shaped by the fear of another."',
            'Objective': 'reflective',
            'Assessment & Therapeutic Intervention':
              'The writer and Rafaelina processed the changes and new relational dynamics. The writer provided reflective listening, validation, encouragement, psychoeducation, and support.',
            'Reaction to Intervention':
              'relief and insight\ntears\nrecognition \nclarity\ncuriosity',
            'Plan and Collaboration':
              'Continue somatic experiencing to deepen safety and resilience in the nervous system. The writer and Rafaelina will continue working on her goals in the next session, while also preparing for termination and transition.',
            'Therapist Reflection and Insight (optional)': '',
            'Progress': 'Progress',
            'Full Name & Credentials (Signature)':
              'Tetyana Sabers MHC-LP/ Wendy Pinder CAGS MA LMHC',
        ...
        },
        {
          ...
          session: {
            'Session Duration': 'Session began at 10am and ended at 10:53am',
            'Mental Status (optional)': '',
            'Suicidality': 'Not Present',
            'Homicidality': 'Not Present',
            'Subjective':
              'Client expressed being worried about finances. Client explored her fears and thought of ways to take action to decrease her anxiety. Client is able to recognize what she is able to control and what she is not able to control.',
            'Objective': 'Client affect and mood were congruent. Client looked awake and alert.',
            'Assessment & Therapeutic Intervention':
              'Therapist provided person centered therapy by providing unconditional positive regard. Therapist explored clients feelings of shame and guilt. Assisted client in identifying and replacing negative self talk messages used to reinforce low self esteem. Therapist explored with client thoughts and overthinking patterns.\nTherapist explored goals with client.',
            'Reaction to Intervention': 'Client was receptive',
            'Plan and Collaboration':
              'Continue to encourage client to think of SMART goals\nSchedule weekly Session',
            'Therapist Reflection and Insight (optional)': '',
            'Progress': 'No Progress',
        ...
        {
          noteId: 'fad4f516-de3e-4c6d-8aaa-a28b2266efea',
          sessionId: 'session-46',
          session: {
            'Session Duration': '3pm - 3:55pm',
            'Encounter Type & Method': 'Video Telehealth',
            'Suicidality': 'Not Present',
            'Homicidality': 'Not Present',
            'Subjective':
              'J spoke about wrapping up their semester - overall feeling good about their pacing.',
            'Objective': 'The client was aware of time, place and date during session.',
            'Assessment & Therapeutic Intervention':
              'This writer and J spoke about their progress towards their first semester of school - feeling excited that they have been working towards this accomplishment and preparing for the next semester. This writer spoke about reminders of self-care to help ease feelings of burnout from the exhaustion of the semester.',
            'Reaction to Intervention': 'J had a positive reaction to the intervention.',
            'Plan and Collaboration':
              'This writer plans to continue to check in with J on how they are managing feelings of distress and building confidence.',
            'Progress': 'Progress',
            'Full Name & Credentials (Signature)': 'Deiarra Canty LMHC',
        ...
        },
        {
          ...
          session: {
            ...
            'Objective': 'The client was aware of time, place and date during session.',
            'Assessment & Therapeutic Intervention':
              'This writer and J spoke again about their concerns with school - reminders of resources for help when needed and seeking support with loved ones especially during the upcoming holiday breaks.\n\n\nThis writer and J also spoke further about stress/time management - taking time for self-care and time for themselves between their workload and reminders of breaking down their tasks.',
            'Reaction to Intervention': 'J had a positive reaction to the intervention.',
            'Plan and Collaboration':
              'This writer plans to continue to check in with J on how they are managing feelings of distress and building confidence.',
            'Progress': 'Progress',
            'Full Name & Credentials (Signature)': 'Deiarra Canty LMHC',
            'Date Completed': '11/20/2025',
          },
          practitionerId: 2,
          patientId: 27,
          type: SessionTypeEnum.intake,
        ...
        {
          noteId: 'b1c146a8-15e4-41a2-afd4-4756a380cd4d',
          sessionId: 'session-48',
          session: {
            'Session Duration': '2pm - 2:55pm',
            'Encounter Type & Method': 'Video Telehealth',
            'Mental Status (optional)': '',
            'Suicidality': 'Not Present',
            'Homicidality': 'Not Present',
            'Subjective':
              'S spoke about some stressors with job options, nervous about taking a leap.',
            'Objective': 'Client was aware of time, place and date during session.',
            'Assessment & Therapeutic Intervention':
              'This writer and S spoke about their feelings of being prepared for a new job opportunity, being aware, doing their research so that they feel more secure about it but overall weighing their options.',
            'Reaction to Intervention': 'S had a positive reaction to the intervention.',
            'Plan and Collaboration':
              'This writer plans to check in with how S is managing feelings of distress/anxiety, work stress, being mindful of their anxiety and how they have been engaging in self-care.',
            'Therapist Reflection and Insight (optional)': '',
            'Progress': 'Progress',
            'Full Name & Credentials (Signature)': 'Deiarra Canty LMHC',
            'Date Completed': '2025-12-10T05:00:00.000Z',
            'Documented by Supervised Clinician (if applicable)': '',
          },
          practitionerId: 2,
          patientId: 29,
        ...
        },
        {
          ...
          session: {
            ...
            'Suicidality': 'Not Present',
            'Homicidality': 'Not Present',
            'Subjective': 'S spoke about some feelings of distress/being overwhelmed.',
            'Objective': 'Client was aware of time, place and date during session.',
            'Assessment & Therapeutic Intervention':
              'This writer and S checked in with their routine with self-care and reminders of the importance of being intentional with self-care.',
            'Reaction to Intervention': 'S had a positive reaction to the intervention.',
            'Plan and Collaboration':
              'This writer plans to check in with how S is managing feelings of distress/anxiety, work stress, being mindful of their anxiety and how they have been engaging in self-care.',
            'Therapist Reflection and Insight (optional)': '',
        ...
        {
          noteId: 'f8332ac1-0161-437d-bfeb-ba7e952a1cf2',
          sessionId: 'session-50',
          session: {
            'Session Duration':
              '9:11 am - 9:53 am (client reported 11 minutes late to the session)',
            'Encounter Type & Method': 'Video Telehealth',
            'Suicidality': 'Denied',
            'Homicidality': 'Not Present',
            'Subjective': 'Ms. Wray reported that she was experiencing feelings of sadness.',
            'Objective':
              'Ms. Wray presented in a sad and discouragement mood. The client was forthcoming and motivated to engage in the counseling process.',
            'Assessment & Therapeutic Intervention':
              "The client appeared reflective and discouraged during the session. They reported experiencing financial challenges, but seemed to be reluctant to reach out to family for help; the client seems to feel that they must  resolve the  issues on their own. The client's strong sense of self-reliance appears to be contributing to their feelings of sadness and distress about their financial situation. Therapeutic interventions used; Supportive Counseling to assist the client with processing feelings of discouragement related to their her financial stressors, CBT Treatment to explore client's reluctance to seek assistance from their family and address any underlying factors that may be contributing to the client's belief system, Therapeutic Feedback to provide constructive input regarding the situation to offer support.",
            'Reaction to Intervention':
              'Ms. Wray was receptive to the intervention. The client was forthcoming and motivated to engage in the counseling process.',
            'Plan and Collaboration':
              '1. CBT Treatment to  support the client in examining negative thought patterns related to asking  others for assistance. 2.  Check-in with client to assess mental and emotional state. 3. Continue working with client to address feelings of discouragement and explore beliefs around   self-reliance. 4. Cognitive Reframing to assist the client with reframing negative thought patterns connected to reaching out to others for help to assist them with developing a healthier perspective regarding the matter.',
            'Therapist Reflection and Insight (optional)':
              'The client’s strong belief in self-reliance appears to be contributing to the heightened emotional distress. Although, the client demonstrates some insight into the situation, they would benefit from further exploration of the underlying beliefs that make it difficult for the client to seek assistance from others.',
            'Progress': 'Progress',
            'Date Completed': '12/22/2025',
            'Documented by Supervised Clinician (if applicable)': 'Wanda Murray, MHC-LP',
          },
          practitionerId: 9,
          patientId: 30,
          type: SessionTypeEnum.intake,
        },
        {
          ...
          session: {
            ...
            'Subjective': 'Ms. Wray reported that she was experiencing feelings of sadness.',
            'Objective':
              'Ms. Wray presented in a reflective mood and was observed crying during the session. The client was forthcoming and motivated to engage in the counseling process.',
            'Assessment & Therapeutic Intervention':
              "Ms. Wray indicated that she was feeling overwhelmed with parenting duties. The therapist validated the client's feelings and explained that being a parent is hard work that involves a lot of responsibility. Also, the therapist praised the client for doing the best that she can in regards to taking good care of her daughter. Ms. Wray may be feeling overwhelmed due to the client's reluctance to reach out to family for support; the client could believe that asking for help may imply that she is not doing a good job as a parent which could be due to culturally learned behavior. The therapist used validation, positive regard, empathetic listening, empathetic understanding, empathetic responses, and therapeutic feedback during the session.",
            'Reaction to Intervention':
              'Ms. Wray was receptive to the intervention. The client was forthcoming and motivated to engage in the counseling process.',
            'Plan and Collaboration':
              "The therapist will check-in with Ms. Wray to assess mental and emotional state. The therapist will revisit the discussion about Ms. Wray's feelings regarding feeling overwhelmed to provide the client with the opportunity to share additional thoughts regarding the matter to offer encouragement, clinical support, and Therapeutic feedback.",
            'Progress': 'Progress',
            'Full Name & Credentials (Signature)': 'Wendy Pinder CAGS MA LMHC',
        ...
        },
        {
          ...
          session: {
            ...
            'Homicidality': 'Not Present',
            'Subjective':
              'The client shared that she spent time with her partner.\nThe client shared that she felt emotional when her partner left and that she was overwhelmed.\nThe client shared that she was tired of the arguments and the ebbs and flows of the relationship.\nThe client shared that she felt a lot of fear surrounding her partner and not wanting to upset him.\nThe client shared that she goes back and forth with the relationship.\nThe client shared that she is not sure whether to end the relationship or to move forward.',
            'Objective': 'The client was self-aware and engaged throughout the session.',
            'Assessment & Therapeutic Intervention':
              'The therapist utilized person-centered therapy.\nThe therapist actively listened, paraphrased, and expressed unconditional positive regard throughout the session.\nThe therapist encouraged the client to prioritize herself and her desired goals.',
            'Reaction to Intervention':
              'The client was receptive to the therapeutic interventions.',
            'Plan and Collaboration': 'The next session is scheduled for 4/10.',
            'Progress': 'No Progress',
        ...
        {
          noteId: '9ef8ee08-8975-4d13-a946-2ffb1f758aab',
          sessionId: 'session-53',
          session: {
            'Session Duration': '9:15 am–10:00 am',
            'Encounter Type & Method': 'Video Telehealth',
            'Suicidality': 'Not Present',
            'Homicidality': 'Not Present',
            'Subjective':
              "During today's session the client shares that she has been feeling less anxious about her relationship. The client has been working on communication with her partner. The client was able to have a conversation with him regarding where they stand and recognizing that they may not be able to meet each other's needs. The client is choosing to focus on herself and things that she would like to do.",
            'Objective': 'The client is oriented to her environment.',
            'Assessment & Therapeutic Intervention':
              'Therapist begin session using person-centered approach including active listening and empathetic understanding. Therapist and the client explore attachment styles and how she is moving through understanding her attachment style. Therapist and the client explore important factors in finding a balance.',
            'Reaction to Intervention': 'The client is receptive in session.',
            'Plan and Collaboration':
              'The client will work on challenging herself to work through how she would like to respond to her partner. The client will sit with discomfort and anxious thoughts. The client will practice journaling as she is observing what comes up for her. Therapist will follow up next week.',
            'Progress': 'Progress',
            'Full Name & Credentials (Signature)': 'Sheila Mashack, Ed.D, LMHC-D, CASAC, CRC',
            'Date Completed': '12/22/2025',
            'Documented by Supervised Clinician (if applicable)': 'Bricy Ansbach, MHC-LP',
          },
          practitionerId: 8,
          patientId: 24,
          type: SessionTypeEnum.intake,
        },
        {
          ...
          session: {
            'Session Duration': '9:00 am–9:53 am',
            'Encounter Type & Method': 'Video Telehealth',
            'Suicidality': 'Not Present',
            'Homicidality': 'Not Present',
            'Subjective':
              "During today's session, the client shares that she is looking to make big decisions in her career including closing out one of her salons and opening up a smaller one. The client is looking forward to the flexibility that this option offers as she wants to be traveling more often as well. The client had a difficult conversation with her partner that she has been dating recently. The client's immediate response that she wants to do is shut down and pull away. The client wants to focus on the things happening in her life that brings her excitement and joy.",
            'Objective': 'The client is oriented to her environment.',
            'Assessment & Therapeutic Intervention':
              'Therapist begin session using Talk therapy including supportive language. Therapist and the client explore what has recently happened in her relationship. Therapist uses Socratic questioning with the client. Therapist has the client challenge her thoughts using CBT approach. Therapist uses mindfulness technique to check in with the part of her that wants to cut ties with her partner as a stress response.',
            'Reaction to Intervention': 'The client is receptive in session.',
            'Plan and Collaboration':
              'The client will work on challenging herself to work through how she would like to respond to her partner. The client will sit with discomfort and anxious thoughts. The client will practice journaling as she is observing what comes up for her. Therapist will follow up next week.',
            'Progress': 'Progress',
        ...
        {
          noteId: '0222480d-83e7-4c96-9e99-73f78b70e6c6',
          sessionId: 'session-55',
          session: {
            'Session Duration': '2;00-2;53pm',
            'Encounter Type & Method': 'Video Telehealth',
            'Suicidality': 'Not Present',
            'Homicidality': 'Not Present',
            'Subjective':
              'The client presented as moderately upset. She stated she will do her best academically this semester, aiming for a passing grade to continue in the spring. She reports feeling that her unmedically diagnosed seasonal depression has worsened, making coursework a struggle. These factors have increased her anxiety.',
            'Objective': 'The client was positive and cooperative.',
            'Assessment & Therapeutic Intervention': 'CBT Therapy  Solution  Focused  Therapy.',
            'Reaction to Intervention': 'The client reacted positively to the intervention.',
            'Plan and Collaboration':
              'To have the client follow the goals and objectives contained within the current treatment plan.',
            'Progress': 'No Progress',
            'Full Name & Credentials (Signature)': 'Sandra Swartwout, LMHC-D',
            'Date Completed': '12/02/2025',
            'Documented by Supervised Clinician (if applicable)': 'Nerissa G. Truitt MHC LP',
          },
          practitionerId: 8,
          patientId: 32,
          type: SessionTypeEnum.intake,
        },
        {
          ...
          session: {
            ...
            'Homicidality': 'Not Present',
            'Subjective':
              'The client presented as upset, expressing low confidence in passing her classes this semester. She reported seeking help and tutoring, but feels unsupported by the school. The client stated her hope is to simply get through the semester. These factors have contributed to her current upset feelings.',
            'Objective': 'The client was positive and cooperative.',
            'Assessment & Therapeutic Intervention': 'CBT Therapy  Solution  Focused  Therapy.',
            'Reaction to Intervention': 'The client reacted positively to the intervention.',
            'Plan and Collaboration':
            ...
            'Progress': 'No Progress',
            'Full Name & Credentials (Signature)': 'Sandra Swartwout, LMHC-D',
            'Date Completed': '11/18/2025',
            'Documented by Supervised Clinician (if applicable)': 'Nerissa G, Truitt MHLP',
          },
          practitionerId: 8,
          patientId: 32,
          type: SessionTypeEnum.intake,
        ...
        {
          noteId: 'e7c3b848-83e0-4aca-bc82-7ee5a843e850',
          sessionId: 'session-57',
          session: {
            'Session Duration': '9;00-9;53 am',
            'Encounter Type & Method': 'Video Telehealth',
            'Suicidality': 'Not Present',
            'Homicidality': 'Not Present',
            'Subjective':
              'The client presented in a very upbeat mood. She was accepted into a medical school, which is in a metro area and close to family. She mentioned dating more and has decided there is no rush for a relationship. She stated she has been slowing down and taking life as it comes, which has reduced her anxiety.',
            'Objective': 'The Client was cooperative and appropriate.',
            'Assessment & Therapeutic Intervention': 'CBT Therapy. Solution-Focused Therapy',
            'Reaction to Intervention': 'The client responded positively to the intervention.',
            'Plan and Collaboration':
              'The client will continue to follow the goals and objectives contained within the current treatment plan.',
        ...
        },
        {
          ...
          session: {
            ...
            'Homicidality': 'Not Present',
            'Subjective':
              'The client presented in a very upbeat mood, stating she feels like a whole person, having realized her potential and value through hard work. This has led her to utilize her new coping skills. She has decided to space out therapy sessions to once a month, wanting full access to her learned coping strategies. These factors have lessened her anxious behaviors.',
            'Objective': 'The Client was cooperative and appropriate.',
            'Assessment & Therapeutic Intervention': 'CBT Therapy. Solution-Focused Therapy',
            'Reaction to Intervention': 'The client responded positively to the intervention.',
            'Plan and Collaboration':
