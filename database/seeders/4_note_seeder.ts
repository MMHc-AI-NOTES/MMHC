    ...
    try {
      const sessionsData = [
...

        {
          ...
          session: `Session Duration: 9:00 - 9:53 pm  \n\nEncounter Type & Method: Video Telehealth  \n\nMental Status (optional):   \n\nSuicidality: Denied  \n\nHomicidality: None  \n\nSubjective: Client shared ongoing stress related to unemployment and described feelings of inadequacy about not having secure income. She expressed a desire to return to the workforce, stating that he wants to “get into something” and believes he would qualify because she has no criminal record and has already paid past debts. Client noted increasing motivation to take steps toward employment and expressed willingness to visit workforce assistance locations, create a résumé, and begin applying for seasonal and full-time positions. He verbalized discouragement about finances during the holidays but also a renewed sense of determination to change her situation./n/n Objective: Client presented as alert, oriented, and engaged. Affect anxious but motivated. Speech coherent; thought content focused on employment barriers and next steps. No safety concerns observed./n/n Assessment & Therapeutic Intervention: Motivational interviewing to reinforce client’s readiness for action and highlight her internal strengths. Behavioral activation by helping her identify concrete, time-specific steps for job searching and résumé development./n/n Problem-solving intervention to break down tasks into manageable actions (e.g., visiting employment centers early, creating one résumé to send out widely).Cognitive reframing to shift self-talk from “I’m not good enough” to “I have skills, no criminal record, and I qualify for many positions.”/n/nFuture planning to help her organize her priorities and reduce overwhelm./n/n Reaction to Intervention: Client appeared receptive, encouraged, and increasingly confident as the session progressed. She responded positively to the step-by-step plan and verbalized that she feels more capable of moving forward. She agreed that job searching will be her priority tomorrow and stated she is committed to following the plan./n/n Plan and Collaboration: Client will go to the employment center tomorrow morning when they open to start résumé creation and job-matching services. Begin sending résumés to multiple seasonal and retail positions to quickly generate income. Continue identifying full-time opportunities that match her skills and strengths. Maintain job-searching as a structured daily routine. Follow up in the next session to assess progress, address barriers, and adjust the employment plan if needed./n/n Therapist Reflection and Insight (optional): /n/n Progress: Progress/n/n Therapist Initials: Chantal Amoussou, LMHC-D/n/n Date Completed: 12/15/2025/n/n Documented by Supervised Clinician (if applicable):`,
          practitionerId: 8,
          patientId: 36,
          type: SessionTypeEnum.intake,
        },
      ...
      if (!cptCode) {
        throw new Error(
          "CPT code 90791 not found. Please run CPT code seeder first."
        );
      }
