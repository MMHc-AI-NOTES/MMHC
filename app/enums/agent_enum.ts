export const modelAgents = [
  ...
  'arn:aws:sagemaker:us-east-1:199990519622:endpoint/mmh-SageMaker-v5'
] as const
...
export const agentModelKeys = {
  ...
  CUSTOM_DEPLOYMENT_V3_02042026:
    'arn:aws:bedrock:us-east-1:199990519622:custom-model-deployment/cxwsnnx1qsw8',
  SAGEMAKER_DEPLOYMENT_V5: 'arn:aws:sagemaker:us-east-1:199990519622:endpoint/mmh-SageMaker-v5',
} as const
